          ...
          {processes.map((proc: any, i: number) => {
            ...
            return (
              <FadeIn 
                ...
                direction="up" 
                delay={i * 0.1}
                className={`p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-outline-variant/30 flex flex-col justify-between min-h-[300px] ${isDarker ? 'bg-surface-container' : ''}`}
              >
